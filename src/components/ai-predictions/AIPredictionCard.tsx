...
const AIPredictionCardInner = ({ 
  ...
  return (
    <Card className={cn(
      "w-full min-w-0 bg-card border-2 border-primary/70 overflow-hidden rounded-2xl shadow-md",
      ...
      <CardContent className="p-0">
        ...
        <div className="px-2.5 md:px-3.5 pb-2 md:pb-3">
          <Tabs defaultValue="main" className="w-full min-w-0">
            ...
            <TabsContent value="correct" className="mt-2 md:mt-3">
              <CorrectScoreTab prediction={prediction} hasAccess={hasAccess} displayTier={displayTier} />
            </TabsContent>
          </Tabs>
        </div>
