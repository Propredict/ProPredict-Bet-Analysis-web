...
export function LeagueStatsRedCardsTab({ leagueId, leagueName }: Props) {
  const { data, isLoading, error } = useLeagueRedCards(leagueId);
  const players = (data as RedCardsResponse)?.players || [];
      ...
      <Card className="p-4 bg-card border-border">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold">{leagueName} Top Red Cards</span>
          </div>
