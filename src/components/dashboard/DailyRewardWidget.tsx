import { Gift, Flame, Lock, Trophy, Zap, Check, Loader2, Star } from "lucide-react";
...
export function DailyRewardWidget() {
  ...
  const displayStreak = claimedToday ? currentStreak : currentStreak;
  const nextDay = claimedToday ? (currentStreak % 7) + 1 : Math.max(currentStreak, 0) + 1;
