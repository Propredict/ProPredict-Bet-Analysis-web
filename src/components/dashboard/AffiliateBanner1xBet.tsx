...
export function AffiliateBanner1xBet({ href = DEFAULT_AFFILIATE_URL }: AffiliateBanner1xBetProps = {}) {
  ...
  return (
    <a
      ...
      className="group block relative overflow-hidden rounded-xl border border-white/10 shadow-lg hover:shadow-xl hover:border-blue-400/40 transition-all w-full max-w-3xl mx-auto"
    >
