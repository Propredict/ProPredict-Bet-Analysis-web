...
export function TodaysTopPicks() {
  ...
  const proPick = todayTips.find((t: any) => t.tier === "exclusive" && !isExcluded(t));
  const premiumPick = todayTips.find((t: any) => t.tier === "premium" && !isExcluded(t));
  ...
  const picks = [
    {
      ...
      locked: false,
      seeAllLabel: "See all Free Picks / Pogledaj sve Free Picks",
    ...
    },
    {
      ...
      locked: true,
      seeAllLabel: "See all Top Picks / Pogledaj sve Top Picks",
