        ...
        <Card className="bg-card border-border">
          <CardContent className="p-3 md:p-4">
            <p className="text-xs text-muted-foreground leading-relaxed">
              Welcome to <span className="text-primary font-medium">AI vs Members</span> — a transparent comparison
        ...
        <Section icon={Trophy} iconColor="bg-amber-500/20 text-amber-500" title="Arena Points System">
          ...
          <div className="space-y-1.5 mb-2.5">
            <div className="flex items-center gap-2 text-[10px] md:text-xs">
              ...
              <span className="text-muted-foreground">→ +1 point awarded</span>
            </div>
            <div className="flex items-center gap-2 text-[10px] md:text-xs">
            ...
            <div className="flex items-center gap-2 text-[10px] md:text-xs">
              ...
              <span className="text-muted-foreground">→ waiting for match result</span>
            </div>
          </div>
          <p className="text-[10px] md:text-xs text-muted-foreground italic">
