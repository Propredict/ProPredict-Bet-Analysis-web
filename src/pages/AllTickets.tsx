...
export default function AllTickets() {
  ...
  return <div className="section-gap">
      ...
      <div className="grid grid-cols-3 gap-1.5 sm:gap-2">
        <AllTicketsStatCard icon={Calendar} count={dailyCount} label="Daily" accentColor="primary" />
        <AllTicketsStatCard icon={Star} count={exclusiveCount} label="Pro" accentColor="accent" />
