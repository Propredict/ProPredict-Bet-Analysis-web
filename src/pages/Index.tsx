    ...
    <div className="space-y-6">
        ...
        {!isAndroid && (
          <a
            ...
            className="flex items-center rounded-xl border border-primary/30 bg-card shadow-md hover:border-primary/50 transition-all group cursor-pointer overflow-hidden"
          >
            <img 
