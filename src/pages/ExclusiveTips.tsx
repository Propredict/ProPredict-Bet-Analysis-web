...
export default function ExclusiveTips() {
  ...
  const exclusiveTips = tips.filter(tip => tip.tier === "exclusive" && tip.tip_date === todayBelgrade && (!tip.category || tip.category === "standard" || tip.category === "ai_pro"));
        ...
        {isLoading ? (
          ...
          <Card className="p-8 bg-card border-border">
            <div className="flex flex-col items-center justify-center text-muted-foreground">
              ...
              <p className="text-primary mb-1">No Pro Insights available</p>
