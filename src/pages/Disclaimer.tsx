      ...
      <div>
        ...
        <div className="space-y-3">
          ...
          <div className="border border-amber-500/50 bg-amber-500/10 rounded-lg p-3">
            ...
            <p className="text-xs text-muted-foreground">
              ProPredict does <strong className="text-foreground">not encourage or promote</strong> gambling activities. The platform focuses exclusively on sports analytics and informational insights.
            </p>
          </div>
